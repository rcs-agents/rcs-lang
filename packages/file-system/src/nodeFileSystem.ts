...
export class NodeFileSystem implements IFileSystem {
  async readFile(filePath: string, encoding: string = 'utf8'): Promise<Result<string>> {
    try {
  ...
  async writeFile(filePath: string, content: string, encoding: string = 'utf8'): Promise<Result<void>> {
    try {
