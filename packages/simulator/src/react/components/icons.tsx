...
export function BatteryIcon() {
  return (
    <svg
      style={{ height: '0.75rem', transform: 'rotate(270deg)' }}
      viewBox="0 0 16 16"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M0 2H14V5H16V11H14V14H0V2ZM12 4H7V12H12V4Z"
          fill="currentColor"
        />{' '}
      </g>
    </svg>
...
export function CellSignalIcon() {
  return (
    <svg
      style={{ height: '1rem' }}
      viewBox="0 0 512 512"
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          {' '}
          <g id="drop" fill="currentColor" transform="translate(42.666667, 85.333333)">
            {' '}
            <path
